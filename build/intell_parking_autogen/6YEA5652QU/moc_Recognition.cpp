...
QT_MOC_LITERAL(1, 12, 7), // "recogni"
QT_MOC_LITERAL(2, 20, 10), // "cv::String"
QT_MOC_LITERAL(3, 31, 0), // ""
QT_MOC_LITERAL(4, 32, 3) // "img"

    },
    "Recognition\0recogni\0cv::String\0\0img"
};
...
void Recognition::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { cv::String _r = _t->recogni((*reinterpret_cast< const QString(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< cv::String*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
}
